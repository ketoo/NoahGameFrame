...
namespace NFCoreEx
{
    public abstract class NFIKernel
    {
        ...
        public abstract bool SetPropertyInt(NFIDENTID self, string strPropertyName, int nValue);
        ...
        public abstract int QueryPropertyInt(NFIDENTID self, string strPropertyName);
        ...
        public abstract bool SetRecordInt(NFIDENTID self, string strRecordName, int nRow, int nCol, int nValue);
        ...
        public abstract int QueryRecordInt(NFIDENTID self, string strRecordName, int nRow, int nCol);
