...
namespace NFCoreEx
{
    public class NFCObject : NFIObject
    {
        ...
        public override bool SetPropertyInt(string strPropertyName, int nValue)
        {
        ...
        public override bool SetPropertyObject(string strPropertyName, NFIDENTID obj)
        {
			...
			{
                NFIValueList valueList = new NFCValueList();
                valueList.AddObject(new NFIDENTID(0));
                property = mPropertyManager.AddProperty(strPropertyName, valueList);
            }
        ...
        public override int QueryPropertyInt(string strPropertyName)
        {
			NFIProperty property = mPropertyManager.GetProperty(strPropertyName);
			if (null != property)
			{
        ...
        public override bool SetRecordInt(string strRecordName, int nRow, int nCol, int nValue)
        {
			NFIRecord record = mRecordManager.GetRecord(strRecordName);
			if (null != record)
			{
        ...
        public override int QueryRecordInt(string strRecordName, int nRow, int nCol)
        {
			NFIRecord record = mRecordManager.GetRecord(strRecordName);
			if (null != record)
			{
