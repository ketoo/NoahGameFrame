...
namespace NFCoreEx
{
    ...
    class MainEx
    {
        ...
        public static void Main()
        {
			...
			NFIDENTID ident = new NFIDENTID(1);
			...
			Console.WriteLine(gameObject.QueryRecordObject("testRecord", 0, 3).nData64);
            ...
            kernel.CreateObject(new NFIDENTID(2), 0, 0, "CLASSAAAAA", "CONFIGINDEX", new NFCValueList());
            kernel.DestroyObject(new NFIDENTID(2));


            Console.WriteLine(" ");
			Console.WriteLine("***************NFHeartBeat*******************");
            kernel.AddHeartBeat(new NFIDENTID(1), "TestHeartBeat", HeartBeatEventHandler, 5.0f, new NFCValueList());
