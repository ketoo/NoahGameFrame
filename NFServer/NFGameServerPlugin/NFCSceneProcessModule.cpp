...
{
    if ( var.GetCount() != 4 
        || !var.TypeEx(TDATA_TYPE::VTYPE_OBJECT, TDATA_TYPE::VTYPE_INT, 
        TDATA_TYPE::VTYPE_INT, TDATA_TYPE::VTYPE_INT, TDATA_TYPE::VTYPE_UNKNOWN))
    {
        return 0;
    }
...
{
    if (1 != var.GetCount()
        || !var.TypeEx(TDATA_TYPE::VTYPE_INT, TDATA_TYPE::VTYPE_UNKNOWN))
    {
        return -1;
    }
