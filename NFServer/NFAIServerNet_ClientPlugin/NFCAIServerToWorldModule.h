...
protected:
    ...
    void OnSocketWSEvent(const SockIndex nSockIndex, const NF_NET_EVENT eEvent, NFINet* pNet);

protected:
    void Register(NFINet* pNet);
	void ServerReport();
    void RefreshWorldInfo();
    void TransPBToProxy(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen);
