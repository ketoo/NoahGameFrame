...
protected:
	...
	void OnClienReqStateSyncProcess(const int nSockIndex, const int nMsgID, const char * msg, const uint32_t nLen);
	...
	void OnGuildTransWorld(const int nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen);
