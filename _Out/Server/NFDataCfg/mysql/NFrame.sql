...
ALTER TABLE `Player` ADD `MAXHP` bigint(11) DEFAULT '0' COMMENT '生命值';
ALTER TABLE `Player` ADD `MAXMP` bigint(11) DEFAULT '0' COMMENT '法力值';
ALTER TABLE `Player` ADD `MAXSP` bigint(11) DEFAULT '0' COMMENT '体力';
ALTER TABLE `Player` ADD `HPREGEN` bigint(11) DEFAULT '0' COMMENT '生命值回复';
ALTER TABLE `Player` ADD `SPREGEN` bigint(11) DEFAULT '0' COMMENT '体力回复';
ALTER TABLE `Player` ADD `MPREGEN` bigint(11) DEFAULT '0' COMMENT 'MP回复';
ALTER TABLE `Player` ADD `ATK_VALUE` bigint(11) DEFAULT '0' COMMENT '物理攻击力';
ALTER TABLE `Player` ADD `DEF_VALUE` bigint(11) DEFAULT '0' COMMENT '物理防御力';
ALTER TABLE `Player` ADD `MOVE_SPEED` bigint(11) DEFAULT '0' COMMENT '移动速度,默认单位是10000=1米';
ALTER TABLE `Player` ADD `ATK_SPEED` bigint(11) DEFAULT '0' COMMENT '攻击速度默认10000';
ALTER TABLE `Player` ADD `ATK_FIRE` bigint(11) DEFAULT '0' COMMENT '火';
ALTER TABLE `Player` ADD `ATK_LIGHT` bigint(11) DEFAULT '0' COMMENT '雷电';
ALTER TABLE `Player` ADD `ATK_ICE` bigint(11) DEFAULT '0' COMMENT '冰';
ALTER TABLE `Player` ADD `ATK_POISON` bigint(11) DEFAULT '0' COMMENT '毒';
ALTER TABLE `Player` ADD `DEF_FIRE` bigint(11) DEFAULT '0' COMMENT '火抗';
ALTER TABLE `Player` ADD `DEF_LIGHT` bigint(11) DEFAULT '0' COMMENT '雷电抗';
ALTER TABLE `Player` ADD `DEF_ICE` bigint(11) DEFAULT '0' COMMENT '冰抗';
ALTER TABLE `Player` ADD `DEF_POISON` bigint(11) DEFAULT '0' COMMENT '毒抗';
ALTER TABLE `Player` ADD `DIZZY_GATE` bigint(11) DEFAULT '0' COMMENT '眩晕开关';
ALTER TABLE `Player` ADD `MOVE_GATE` bigint(11) DEFAULT '0' COMMENT '移动开关';
ALTER TABLE `Player` ADD `SKILL_GATE` bigint(11) DEFAULT '0' COMMENT '技能开关';
ALTER TABLE `Player` ADD `PHYSICAL_GATE` bigint(11) DEFAULT '0' COMMENT '物理免疫开关';
ALTER TABLE `Player` ADD `MAGIC_GATE` bigint(11) DEFAULT '0' COMMENT '魔法免疫开关';
ALTER TABLE `Player` ADD `BUFF_GATE` bigint(11) DEFAULT '0' COMMENT 'BUFF免疫开关';
