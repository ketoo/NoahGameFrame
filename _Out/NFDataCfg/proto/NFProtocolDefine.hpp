...
namespace NFrame
{
	...
	public:
		...
		static const std::string& HeroCnfID4(){ static std::string x = "HeroCnfID4"; return x; };// string
		...
		static const std::string& HeroID4(){ static std::string x = "HeroID4"; return x; };// object
		...
		static const std::string& HeroStar4(){ static std::string x = "HeroStar4"; return x; };// int
		...
		static const std::string& OpponentHero4(){ static std::string x = "OpponentHero4"; return x; };// string
		...
		static const std::string& OpponentHeroStar4(){ static std::string x = "OpponentHeroStar4"; return x; };// int
