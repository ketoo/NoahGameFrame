...
ALTER TABLE `Guild` ADD `Guild_AppyList` text COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '';
ALTER TABLE `Guild` ADD `Guild_Building` text COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '';
ALTER TABLE `Guild` ADD `Guild_MemberList` text COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '';
ALTER TABLE `Guild` ADD `Guild_WarList` text COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '';
...
ALTER TABLE `Player` ADD `Guild_AppyList` text COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '';
ALTER TABLE `Player` ADD `Guild_Building` text COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '';
ALTER TABLE `Player` ADD `Guild_MemberList` text COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '';
ALTER TABLE `Player` ADD `Guild_WarList` text COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '';
...
ALTER TABLE `Player` ADD `TaskMonsterList` text COLLATE utf8mb4_unicode_ci  DEFAULT '' COMMENT '';
