...
public:
    ...
    // 下一次计时
    void NextTimer(ValueType nValue)
    {
        SetStartTime(nValue);
    }
    ...
    // 设置计时器间隔时间
    ValueType GetStartTime() const
    {
        return m_nStartTime;
    }
    ValueType GetSpaceTime() const
    {
        return m_nSpaceTime;
    }
    void SetSpaceTime(ValueType nValue)
    {
        m_nSpaceTime = nValue;
    }
    void AddSpaceTime(ValueType nValue)
    {
        m_nSpaceTime += nValue;
    }
