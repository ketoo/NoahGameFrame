...
public:
    ...
    virtual std::shared_ptr<NFIProperty> AddProperty(const NFIDENTID& self, std::shared_ptr<NFIProperty> pProperty) = 0;
    virtual std::shared_ptr<NFIProperty> AddProperty(const NFIDENTID& self, const std::string& strPropertyName, const TDATA_TYPE varType, bool bPublic, bool bPrivate, bool bSave, bool bView, int nIndex, const std::string& strScriptFunction) = 0;
