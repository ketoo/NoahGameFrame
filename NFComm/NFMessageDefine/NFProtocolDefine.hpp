...
namespace NFrame
{
	...
	public:
		...
		public:
			...
			static const int BuyBackCount = 9;//int
			static const int FightHeroCnf = 10;//string
			static const int HeroCnf1 = 11;//string
			static const int HeroCnf2 = 12;//string
			static const int HeroCnf3 = 13;//string
			static const int HeroStar1 = 14;//int
			static const int HeroStar2 = 15;//int
			static const int HeroStar3 = 16;//int
