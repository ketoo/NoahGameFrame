...
enum EGameMsgID {
  ...
  EGMI_REQ_ACK_SEND_INVITE = 6000,
  EGMI_REQ_ACK_ACCEPT_INVITE = 6001,
  EGMI_REQ_ACK_REJECT_INVITE = 6002,
  EGMI_REQ_ACK_IGNORE_INVITE = 6003,
  EGMI_REQ_ACK_BLOCK_PLAYER = 6010,
  EGMI_REQ_ACK_UNBLOCK_PLAYER = 6011,
...
const EGameMsgID EGameMsgID_MAX = EGMI_ACK_INVITE_ADD;
