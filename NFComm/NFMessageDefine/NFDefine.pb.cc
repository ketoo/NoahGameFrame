...
void protobuf_AddDesc_NFDefine_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\rBATTLE_SINGLE\020\000\022\023\n\017BATTLE_PVE_TEAM\020\001", 8077);
