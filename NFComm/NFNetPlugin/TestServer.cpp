...
public:
    ...
    void ReciveHandler(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen)
    {
        std::string str;
        str.assign(msg, nLen);
    ...
    void EventHandler(const SockIndex nSockIndex, const NF_NET_EVENT e, NFINet* p)
    {
