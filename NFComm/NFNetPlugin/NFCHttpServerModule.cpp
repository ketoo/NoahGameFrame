...
void NFCHttpServerModule::OnReceiveNetPack(const NFHttpRequest& req, const std::string& strCommand, const std::string& strUrl)
{
...
bool NFCHttpServerModule::ResponseMsg(const NFHttpRequest & req, const std::string& strMsg, NFWebStatus code, const std::string& strReason)
{
	return m_pHttpServer->ResponseMsg(req, strMsg, code, strReason);
}

bool NFCHttpServerModule::ResponseFile(const NFHttpRequest & req, const std::string & strPath, const std::string & strFileName)
{
