...
class NFStackWalker : public StackWalker
{
public:
    NFStackWalker()
        : StackWalker()
    ...
    NFStackWalker(DWORD dwProcessID, HANDLE hProcess)
        : StackWalker(dwProcessID, hProcess)
    {
    }

    virtual void OnOutput(const char* szInfo)
    {
        std::cout << szInfo << std::endl;
        StackWalker::OnOutput(szInfo);
    }
};