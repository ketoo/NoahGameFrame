...
public:
    ...
    template<typename BaseType>
    bool AddPropertyCallBack(const NFIDENTID& self, const std::string& strPropertyName, BaseType* pBase, int (BaseType::*handler)(const NFIDENTID&, const std::string&, const NFIDataList::TData&, const NFIDataList::TData&))
    {
		NF_SHARE_PTR<NFIObject> pObject = GetObject(self);
		if (pObject.get())
		{
    ...
    template<typename BaseType>
    bool ResgisterCommonPropertyEvent(BaseType* pBase, int (BaseType::*handler)(const NFIDENTID&, const std::string&, const NFIDataList::TData&, const NFIDataList::TData&))
    {
    ...
    virtual bool SetPropertyFloat(const NFIDENTID& self, const std::string& strPropertyName, const double dValue) = 0;
    ...
    virtual const NFIDENTID& GetPropertyObject(const NFIDENTID& self, const std::string& strPropertyName) = 0;
    ...
    virtual const NFIDENTID& GetRecordObject(const NFIDENTID& self, const std::string& strRecordName, const int nRow, const int nCol) = 0;
    ...
    virtual const NFIDENTID& GetRecordObject(const NFIDENTID& self, const std::string& strRecordName, const int nRow, const std::string& strColTag) = 0;
    ...
    virtual const NFIDENTID& GetGridID(const float fX, const float fY, const float fZ) = 0;
