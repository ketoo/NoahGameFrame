...
public:
	...
	virtual bool StartRouteEvent(const NFGUID& self, const NFIDataList& xDataList) = 0;

	virtual bool ReceiveRouteEvent(const NFGUID& self, const NFIDataList& xDataList) = 0;
};
