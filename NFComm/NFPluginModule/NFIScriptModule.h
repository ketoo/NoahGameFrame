...
static const NFGUID& KernelModule_GetPropertyObject(NFINT64 kernelAddress, const NFGUID* self, const std::string& strPropertyName)
{
	NFIKernelModule* pKernelModule = (NFIKernelModule*)kernelAddress;
...
static const NFGUID& KernelModule_GetRecordObject(NFINT64 kernelAddress, const NFGUID* self, const std::string& strRecordName, const int nRow, const int nCol)
{
	NFIKernelModule* pKernelModule = (NFIKernelModule*)kernelAddress;
