...
public:
    ...
    bool AddRecord(const NFIDENTID& self, const std::string& strRecordName, const NFCScriptVarList& varData, const NFCScriptVarList& varKey, const NFCScriptVarList& varDesc, const int nRows, bool bPublic,  bool bPrivate,  bool bSave, int nIndex)
    {
        return m_pKernelModule->AddRecord(self, strRecordName, varData.GetVar(), varKey.GetVar(), varDesc.GetVar(), nRows, bPublic, bPrivate, bSave, nIndex);
    }
