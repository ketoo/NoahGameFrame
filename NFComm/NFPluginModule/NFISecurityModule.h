...
public:
	...
	virtual bool EncodeMsg(const std::string& account, const std::string& strSecurityKey, const int nMessageID, const std::string_view& strMessageData, std::string& output) = 0;
	virtual bool DecodeMsg(const std::string& account, const std::string& strSecurityKey, const int nMessageID, const std::string_view& strMessageData, std::string& output) = 0;
