...
int NFCLuaScriptModule::OnRecordCommonEvent(const NFGUID& self, const RECORD_EVENT_DATA& xEventData, const NFCDataList::TData& oldVar, const NFCDataList::TData& newVar)
{
