...
int NFCMysqlClusterModule::ConfirmAccountInfo(const std::string& strAccount, const std::string& strPassword)
{
...
int NFCMysqlClusterModule::CreateAccount(const std::string& strAccount, const std::string& strPassword)
{
...
int NFCMysqlClusterModule::HasAccount(const std::string& strAccount)
{
    char szExec[MAX_PATH] = { 0 };
...
int NFCMysqlClusterModule::HasRole(const std::string& strRoleName)
{
    char szExec[MAX_PATH] = { 0 };
...
int NFCMysqlClusterModule::CreateRole(const std::string& strAccount, const std::string& strRoleName)
{
...
void NFCMysqlClusterModule::CheckTable()
{
    char szExec[MAX_PATH] = { 0 };
...
void NFCMysqlClusterModule::AddPropertyToRole(const std::string& strProperty)
{
    char szExec[MAX_PATH] = { 0 };
...
void NFCMysqlClusterModule::AddPropertyToAccount(const std::string& strProperty)
{
    char szExec[MAX_PATH] = { 0 };
    //sprintf( szExec, "alter table docdsp  add dspcode char(256)", mstrPlayerTableName.c_str(), strAccount.c_str(), strRoleName.c_str() );
...
int NFCMysqlClusterModule::HasPropertyInRole(const std::string& strProperty)
{
    char szExec[MAX_PATH] = { 0 };
...
int NFCMysqlClusterModule::HasPropertyInAccount(const std::string& strProperty)
{
    char szExec[MAX_PATH] = { 0 };
    //sprintf( szExec, "insert into %s ( Account, RoleName ) values ( '%s', '%s' )", mstrPlayerTableName.c_str(), strAccount.c_str(), strRoleName.c_str() );
    return 0;
...
void NFCMysqlClusterModule::AddRecordToRole(const std::string& strProperty)
{

}

void NFCMysqlClusterModule::AddRecordToAccount(const std::string& strProperty)
{

}

int NFCMysqlClusterModule::QueryAccountProperty(const std::string& strAccount, NFIValueList& value)
{
    char szExec[MAX_PATH] = { 0 };
...
int NFCMysqlClusterModule::QueryRoleProperty(const std::string& strRoleName, NFIValueList& value)
{
    char szExec[MAX_PATH] = { 0 };
...
int NFCMysqlClusterModule::QueryRoleRecord(const std::string& strRoleName, NFIValueList& value)
{
    char szExec[MAX_PATH] = { 0 };
...
int NFCMysqlClusterModule::QueryAccountRecord(const std::string& strAccount, NFIValueList& value)
{
    char szExec[MAX_PATH] = { 0 };
...
int NFCMysqlClusterModule::SetAccountProperty(const std::string& strAccount, const NFIValueList& value)
{
    std::string strInfo;
...
int NFCMysqlClusterModule::SetRoleProperty(const std::string& strRoleName, const NFIValueList& value)
{
    if (value.GetCount() <= 0)
    {
        return -1;
...
int NFCMysqlClusterModule::SetRoleRecord(const std::string& strRoleName, const NFIValueList& value)
{
    std::string strInfo;
    for (int i = 0; i < value.GetCount(); i++)
    {
...
int NFCMysqlClusterModule::SetAccountRecord(const std::string& strAccount, const NFIValueList& value)
{
    std::string strInfo;
    for (int i = 0; i < value.GetCount(); i++)
    {
...
int NFCMysqlClusterModule::QueryAccountRoleList(const std::string& strAccount, NFIValueList& value)
{
    char szExec[MAX_PATH] = { 0 };
...
int NFCMysqlClusterModule::DeleteRole(const std::string& strAccount, const std::string& strRoleName)
{
    if (HasRole(strRoleName) > 0)
    {
        NFCValueList valueRoleList;
