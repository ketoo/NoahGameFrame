...
#ifndef NF_ITEM_EQUIP_CONSUME_PROCESS_MODULE_H
#define NF_ITEM_EQUIP_CONSUME_PROCESS_MODULE_H
...
class NFItemEquipConsumeProcessModule
	: public NFIItemConsumeocessModule
{

public:
	NFItemEquipConsumeProcessModule(NFIPluginManager* p)
	{
		pPluginManager = p;
	}
	virtual bool Init();
