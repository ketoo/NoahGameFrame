...
bool NFItemCardConsumeProcessModule::Init()
{
...
bool NFItemCardConsumeProcessModule::AfterInit()
{
...
bool NFItemCardConsumeProcessModule::Shut()
{
    return true;
}

bool NFItemCardConsumeProcessModule::Execute()
{
    return true;
}


int NFItemCardConsumeProcessModule::ConsumeLegal( const NFGUID& self, const std::string& strItemID, const NFDataList& targetID )
{
...
int NFItemCardConsumeProcessModule::ConsumeProcess( const NFGUID& self, const std::string& strItemID, const NFDataList& targetID )
{
