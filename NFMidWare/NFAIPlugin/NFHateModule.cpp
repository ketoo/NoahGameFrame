...
bool NFHateModule::Empty(const NFGUID& self)
{
...
void NFHateModule::CompSortList(const NFGUID& self)
{

}

bool NFHateModule::QueryMaxHateObject(const NFGUID& self, std::list<std::string>& HateList, const int nCount)
{
    return true;
}

const NFGUID& NFHateModule::QueryMaxHateObject(const NFGUID& self)
{
    return NULL_OBJECT;
}
...
bool NFHateModule::ClearHate(const NFGUID& self)
{
    TOBJECTHATEMAP::iterator it = mtObjectHateMap.find(self);
    if (it != mtObjectHateMap.end())
    {
