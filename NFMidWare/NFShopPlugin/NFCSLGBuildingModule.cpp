...
void NFCSLGBuildingModule::OnSLGClienMoveObject(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen)
{
...
void NFCSLGBuildingModule::OnSLGClienUpgradeBuilding(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen)
{
...
void NFCSLGBuildingModule::OnSLGClienCreateItem(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen)
{
