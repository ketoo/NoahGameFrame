...
protected:
	void OnSLGClienMoveObject(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen);
	void OnSLGClienUpgradeBuilding(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen);
	void OnSLGClienCreateItem(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen);
