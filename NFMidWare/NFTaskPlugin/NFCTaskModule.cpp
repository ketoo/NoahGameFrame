...
void NFCTaskModule::OnClientAcceptTask(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen)
{
    CLIENT_MSG_PROCESS( nMsgID, msg, nLen, NFMsg::ReqAcceptTask)
}

void NFCTaskModule::OnClientPushTask(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen)
{
    CLIENT_MSG_PROCESS( nMsgID, msg, nLen, NFMsg::ReqCompeleteTask)
}

void NFCTaskModule::OnClientPushCustom(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen)
{
