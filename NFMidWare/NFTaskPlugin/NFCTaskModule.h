...
protected:
    void OnClientAcceptTask(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen);
    void OnClientPushTask(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen);
    void OnClientPushCustom(const SockIndex nSockIndex, const int nMsgID, const char* msg, const uint32_t nLen);
private:
