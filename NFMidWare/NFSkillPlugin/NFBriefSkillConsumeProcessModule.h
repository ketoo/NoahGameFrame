...
#ifndef NF_BRIEFSKILLCONSUME_PROCESS_MODULE_H
#define NF_BRIEFSKILLCONSUME_PROCESS_MODULE_H
...
class NFBriefSkillConsumeProcessModule
    : public NFISkillConsumeProcessModule
{
public:
    NFBriefSkillConsumeProcessModule( NFIPluginManager* p )
    {
        pPluginManager = p;
    }
    virtual bool Init();
