...
int NFBulletSkillConsumeProcessModule::ConsumeProcess( const NFGUID& self, const std::string& skillID, const NFDataList& other, NFDataList& damageListValue , NFDataList& damageResultList )
{
