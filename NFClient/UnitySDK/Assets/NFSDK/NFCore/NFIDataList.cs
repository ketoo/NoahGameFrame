...
namespace NFSDK
{
    public abstract class NFIDataList
    {
        ...
        public class TData
        {
            ...
            {
                mData = new Object();
                mType = VARIANT_TYPE.VTYPE_UNKNOWN;
            }
            ...
            new public VARIANT_TYPE GetType()
            {
                return mType;
            }
            ...
            {
                if (mType == VARIANT_TYPE.VTYPE_INT)
                {
                    mData = value;
                    return true;
                }
            ...
            {
                if (mType == VARIANT_TYPE.VTYPE_FLOAT)
                {
                    mData = value;
                    return true;
                }
            ...
            {
                if (mType == VARIANT_TYPE.VTYPE_STRING)
                {
                    mData = value;
                    return true;
                }
            ...
            {
                if (mType == VARIANT_TYPE.VTYPE_OBJECT)
                {
                    mData = value;
                    return true;
                }
            ...
            {
                if (mType == VARIANT_TYPE.VTYPE_VECTOR3)
                {
                    mData = value;
                    return true;
                }
